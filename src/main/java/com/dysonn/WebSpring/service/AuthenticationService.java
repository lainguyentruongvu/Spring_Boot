...
import com.dysonn.WebSpring.dto.request.AuthenticationRequest;
import com.dysonn.WebSpring.dto.request.IntrospectRequest;
import com.dysonn.WebSpring.dto.response.AuthenticationResponse;
import com.dysonn.WebSpring.dto.response.IntrospectResponse;
...
public class AuthenticationService {
    ...
    @NonFinal //no insert in constructor
    @Value("${jwt.signerKey}")
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest requests) {
        var user = userRepository.findByUsername(requests.getUsername())
